export default (Blockly) => {
    ...
    // 系统资源
    Blockly.Python['udblockUDPiPlus_feedWDT'] = function(block){
    ...
    Blockly.Python['udblockUDPiPlus_whenButtonPressedIRQ'] = function (block) {
        // console.log(Blockly.Xml.blockToDom(block))
        // console.log(block.toString())
        // console.log(block.nextConnection)
    ...
    // 读取环境光传感器
    Blockly.Python["udblockUDPiPlus_readOBAmbientLightSensor"] = function (block) {
        Blockly.Python.definitions_['import_udrobot'] = 'from udrobot.basic import *';
