export default (Blockly) => {
    ...
    // EXTB_LIST.bt = 'rk'
    // 启动
    Blockly.Python['udblockRKNano_rknanostart'] = function (block) {
        Blockly.Python.definitions_['import_rkpi_basic'] = 'from udrobot.udpi import *';
        return '';
    }
    // 打印
    Blockly.Python['udblockRKNano_print'] = function (block) {
        var text = Blockly.Python.valueToCode(block, "TEXT", Blockly.Python.ORDER_ATOMIC)
        return 'print(' + text + ')\n';
    }
    // 系统资源
    Blockly.Python['udblockRKNano_getStartTime'] = function (block) {
        return ["time.ticks_ms()", Blockly.Python.ORDER_ATOMIC]
    }
    Blockly.Python['udblockRKNano_delay_ms'] = function (block) {
    ...
    Blockly.Python['udblockRKNano_delay_us'] = function (block) {
        var time = Blockly.Python.valueToCode(block, "TIME", Blockly.Python.ORDER_ATOMIC)
        if (parseInt(time) < 0) {
            time = 0;
        }
    ...
    Blockly.Python['udblockRKNano_delay_s'] = function (block) {
        var time = Blockly.Python.valueToCode(block, "TIME", Blockly.Python.ORDER_ATOMIC)
        if (parseInt(time) < 0) {
            time = 0;
        }
    ...
    // // 读取环境光传感器
    // Blockly.Python["udblockRKNano_readAmbientLightSensor"] = function (block) {
    //     
    //     var code = `udpi_sensor.GetAmbientLight(${39})`;
    //     return [code, Blockly.Python.ORDER_ATOMIC];
    // }
    // // 读取声音传感器
    // Blockly.Python["udblockRKNano_readSoundSensor"] = function (block) {
    //     
    //     var code = `udpi_sensor.GetMicrophone(${36})`;
    //     return [code, Blockly.Python.ORDER_ATOMIC];
    // }
    // // 读取陀螺仪传感器
    // Blockly.Python["udblockRKNano_readGryoSensor"] = function (block) {
    //     
    //     var code = `imu.ICM20602.ICM_Get_Gyroscope()`
    //     return [code, Blockly.Python.ORDER_ATOMIC]
    // }
    // // 读取加速度传感器
    // Blockly.Python["udblockRKNano_readAccelSensor"] = function (block) {
    //     
    ...
    // 控制启用主板RGB
    Blockly.Python['udblockRKNano_openOnBoardRGB'] = function (block) {
    ...
    // 控制启用禁用RGB
    Blockly.Python['udblockRKNano_closeOnBoardRGB'] = function (block) {
    ...
    // 控制主板RGB显示颜色
    Blockly.Python["udblockRKNano_setRGBDraw"] = function (block) {
    ...
    Blockly.Python["udblockRKNano_setRGBLineDraw"] = function (block) {
...
`
    ...
    Blockly.Python["udblockRKNano_setRGBLineSingleDraw"] = function (block) {
...
`
    ...
    Blockly.Python['udblockRKNano_setRGBLineSingleOnlyDraw'] = function (block) {
...
`
    ...
    Blockly.Python['udblockRKNano_getWiFiStatus'] = function () {

        return ['udpi_wifi.is_connected()', Blockly.Python.ORDER_ATOMIC]
    }
    Blockly.Python['udblockRKNano_closeConnectToWiFi'] = function (block) {

        var code = `udpi_wifi.disconnect()\n`;
        return code;
    }
    Blockly.Python['udblockRKNano_setConnectToWiFi'] = function (block) {
    ...
    Blockly.Python['udblockRKNano_openWiFiAP'] = function (block) {
    ...
    Blockly.Python['udblockRKNano_udpClientSent'] = function (block) {

        var msg = Blockly.Python.valueToCode(block, 'MSG', Blockly.Python.ORDER_ATOMIC);
        return `udpi_wifi.broadcast(${msg})\n`
    }
    Blockly.Python['udblockRKNano_udpClientReceiveEvent'] = function (block) {
    ...
    Blockly.Python['udblockRKNano_udpClientReceivedText'] = function (block) {
    ...
    // 控制主板蜂鸣器播放
    Blockly.Python['udblockRKNano_setBuzzerPlay'] = function (block) {
    ...
    Blockly.Python['udblockRKNano_setBuzzerPlayMidi'] = function (block) {
    ...
    Blockly.Python['udblockRKNano_menu_buzzerSounds'] = function (block) {
        var code = Blockly.Python.quote_(block.getFieldValue("buzzerSounds"));
        return [code, Blockly.Python.ORDER_ATOMIC];
    };
    Blockly.Python['udblockRKNano_menu_buzzerPitches'] = function (block) {
        var code = Blockly.Python.quote_(block.getFieldValue("buzzerPitches"));
        return [code, Blockly.Python.ORDER_ATOMIC];
    };


    Blockly.Python['udblockRKNano_setBuzzerStop'] = function (block) {
