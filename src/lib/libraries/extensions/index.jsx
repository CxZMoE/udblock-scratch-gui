...
import udblockSensorIconURL from './udblock/传感器.png';
import udblockActorIconURL from './udblock/执行器.png'
...
export default [
    ...
    // 传感器
    NewExtensionConfig('NFC传感器', 'nfcSensor', ["传感器"], "用于检测雨滴，或者水珠的出现。", udblockSensorIconURL),
    ...
    NewExtensionConfig('颜色识别传感器', 'colorDetectSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('环境光传感器', 'lightAmpSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('超声波传感器', 'sonicSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('巡线传感器', 'routeFindingSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('火焰传感器', 'flameDetectSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('模拟灰度传感器', 'simGraySensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('烟雾传感器', 'smokeSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('风速传感器', 'windSpeedSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('土壤湿度传感器', 'dirtHumiditySensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('防水温度传感器', 'waterProofTempSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('DHT11传感器', 'dht11Sensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('四路红外巡线传感器', 'foutChanRouteFinderSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('八路按键模块', 'eightChnKeyboardSensor', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),
    NewExtensionConfig('比比智慧摄像头', 'bibiCamK210', ["传感器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockSensorIconURL),

    // 执行器
    NewExtensionConfig('I2C电机模块', 'i2cMotorModule', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
    NewExtensionConfig('四位数码管', 'digitalTube', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
    NewExtensionConfig('RGB灯带(15灯珠)', 'rgbStript15', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
    NewExtensionConfig('步进电机模块', 'stepperModule', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
    NewExtensionConfig('继电器模块(单路)', 'relayOneChn', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
    NewExtensionConfig('继电器模块(双路)', 'relayTwoChn', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
    NewExtensionConfig('I2C表情面板', 'i2cFacePanel', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
    NewExtensionConfig('OLED显示模组(128x64)', 'oledModuleSSD1306Of128M64', ["执行器"], "支持学习和检测对象的灰度值，返回数字量(0/1)", udblockActorIconURL),
